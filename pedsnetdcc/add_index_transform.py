...
class AddIndexTransform(Transform):
    create_by_table = {
        ...
        'condition_occurrence': ('condition_start_date', 'condition_type_concept_id', 'condition_source_value',),
        'drug_exposure': ('drug_type_concept_id', 'drug_exposure_start_date',),
        'fact_relationship': ('fact_id_1', 'fact_id_2',),
        'location': ('zip', 'state',),
        'measurement': ('measurement_date', 'measurement_type_concept_id', 'measurement_source_value',
