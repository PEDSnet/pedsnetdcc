...
class VocabularyAddIndexTransform(Transform):
    add_by_table = {
        'concept': ('concept_name','standard_concept',),
        'concept_relationship': ('relationship_id', 'concept_id_1','concept_id_2',),
    }
    idx_by_column = {
        'concept_name': 'idx_concept_name',
        'standard_concept': 'idx_standard_concept',
        'relationship_id': 'idx_relationship_id',
        'concept_id_1': 'idx_concept_id_1',
        'concept_id_2': 'idx_concept_id_2',
    }
    ...
    def modify_table(cls, metadata, table):
        ...
        indexes = []
        if not table.name in cls.add_by_table:
            return indexes
        for col_name in cls.add_by_table[table.name]:
